...
const EditCustomer = () => {
  ...
  const fetchCustomer = async () => {
    try {
      console.log('Fetching customer from:', `${API_BASE_URL}/customers/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log('Updating customer at:', `${API_BASE_URL}/customers/${id}`);
      const response = await axios.put(`${API_BASE_URL}/customers/${id}`, formData);
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-100 mt-1 text-sm">Update customer information</p>
              </div>
            </div>
          </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <FiSave className="h-4 w-4 text-blue-600" />
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-blue-800">Update Information</p>
                      <p className="text-xs text-blue-600 mt-1">
                        Make sure to review all changes before saving. Customer data is used for 
                        sales records and communication.
                      </p>
                    </div>
                  </div>
                </div>
